...
class Vanagon
  class Component
    ...
    # the source will be fetched into a temporary directory to attemt to figure out the version if the
    ...
    def force_version
      ...
      raise Vanagon::Error, "Unable to determine source version!" if @version.nil?
      @version
    end
